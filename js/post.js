...
function postLiked(){
    ...
    if(numClick!=0){
        if (numClick==1){
            document.getElementById('commentCount').innerHTML = numClick + " person likes this!";
        }
        else {
            document.getElementById('commentCount').innerHTML = numClick + " people have liked this!";
        }
    }
}
